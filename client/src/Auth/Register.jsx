    ...
    <div class='w-full flex flex-col'>
      ...
      <div class='w-full flex flex-col'>
        ...
        <input
          ...
          class='w-full text-black p-2 py-2 my-2 bg-none border-black outline-none focus:outline-none'
        />
        <select class="w-full text-black p-2 py-2 my-2 bg-none border-black outline-none focus:outline-none">
      ...
      <div class='w-full flex items-center justify-center'>
        <p class='text-base lg:text-lg font-normal text-[#060606] p-2'>Already have an account? <a href="/Login" class='font-semibold underline underline-offset-2 cursor-pointer'>Log in here!</a></p>
      </div>
    </div>
  </div>
</div>
