        ...
        <div class='w-full flex flex-col'>
          ...
          <div class='w-full flex flex-col'>
            ...
            <input
              ...
              class='w-full text-black bg-[#E8F0FE] py-2 p-2 my-2 bg-none border-black outline-none focus:outline-none'
            />
            <select class="w-full bg-[#E8F0FE] text-black py-2 p-2 my-2 bg-none border-black outline-none focus:outline-none">
